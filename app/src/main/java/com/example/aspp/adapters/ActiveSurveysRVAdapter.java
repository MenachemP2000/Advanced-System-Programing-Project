...
public class ActiveSurveysRVAdapter extends RecyclerView.Adapter<ActiveSurveysRVAdapter.MyViewHolder> {
    ...
    int pos;
    public ActiveSurveysRVAdapter(Context context, ArrayList<Video> videos) {
...
//        holder.id.setText(surveys.get(position).get_id() + "");
        ...
        holder.countOfAnswers.setText("The rating is according to " + videos.get(position).getAnswers() + " users who fill this survey");
        holder.ratingBar.setRating(videos.get(position).getRating());
